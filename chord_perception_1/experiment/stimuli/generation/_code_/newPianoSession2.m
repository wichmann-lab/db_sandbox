...
nSess=2;
%=========================================================================
subjID=['newPianoT_subj' num2str(nSubj) '_sess' num2str(nSess)];

%Load previous experimental structure
load(['newPianoT_subj' num2str(nSubj) '_sess1.mat']);
...
for iTrial=(nTrials+1):(nTrials*2)
    ...
    probe=(mean((y(1:(sampRate*durChord),:)),2)')./nTones;
    winProbe=probe.*win;
